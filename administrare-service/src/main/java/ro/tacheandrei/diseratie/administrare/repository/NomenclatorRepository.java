...
@Repository
public interface NomenclatorRepository extends JpaRepository<Nomenclator, Long> , PagingAndSortingRepository<Nomenclator, Long>,
        JpaSpecificationExecutor<Nomenclator> {
